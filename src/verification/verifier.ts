/**
 * Verification protocol — evidence-backed task completion checking.
 *
 * Generates size-appropriate verification checklists and
 * fix-loop instructions for the team pipeline.
 *
 * Adapted from OMX: same protocol, standalone module.
 */
...
export function getVerificationInstructions(
  ...
  const base = `## Verification Protocol
